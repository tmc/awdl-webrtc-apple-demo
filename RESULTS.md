...
| Area | Current result |
| --- | --- |
| Published backend pins | `github.com/tmc/apple v0.6.7`; `github.com/tmc/apple-pion v0.1.2`; no local replace. The most recent two-host matrix below was run against `apple-pion v0.1.1`. |
...
| Network backend build pin | `go list -m -f '{{.Path}} {{.Version}} {{.Replace.Path}}' github.com/tmc/apple github.com/tmc/apple-pion` | `github.com/tmc/apple v0.6.7`; `github.com/tmc/apple-pion v0.1.2`. |
